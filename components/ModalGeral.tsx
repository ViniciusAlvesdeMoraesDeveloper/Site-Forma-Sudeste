...
const ModalGeral = ({ title, content, onClose }: ModalProps) => {
  return (
    <div className="fixed inset-0  bg-opacity-40 flex items-center justify-center p-4 z-50">
      <div className="bg-white p-6 rounded-xl shadow-2xl max-w-4xl w-full max-h-[90vh] overflow-y-auto relative border-2 border-purple-100">
        {/* Header com gradiente laranja */}
        <div className="bg-gradient-to-r from-purple-500 to-purple-600 rounded-t-lg -m-6 mb-6 p-6">
          <div className="flex items-center justify-between">
            <div>
              <h1 className="text-2xl font-bold text-white mb-2">{title}</h1>
              <p className="text-purple-100 text-sm">Última atualização: {new Date().toLocaleDateString('pt-BR')}</p>
            </div>
            <button
        ...
        <div className="text-gray-800 space-y-6">
          ...
          <section className="bg-purple-50 rounded-lg p-4 border-l-4 border-purple-500">
            <h2 className="text-lg font-semibold text-purple-800 mb-2">Importância da Privacidade</h2>
          ...
          <section className="space-y-4">
            ...
            <div className="grid md:grid-cols-2 gap-4">
              <div className="bg-gray-50 p-4 rounded-lg">
                <h3 className="font-semibold text-purple-600 mb-2">✓ Dados Pessoais</h3>
              ...
              <div className="bg-gray-50 p-4 rounded-lg">
                <h3 className="font-semibold text-purple-600 mb-2">✓ Finalidades</h3>
                <ul className="text-sm text-gray-700 space-y-1">
          ...
          <section className="bg-gray-100 rounded-lg p-4">
            ...
            <div className="text-xs text-gray-600 space-y-1">
              <p>📧 Email: gerenciageraltecminas@gmail.com</p>
              <p>📞 Telefone: (31) 97314-4070</p>
