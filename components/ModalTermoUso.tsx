...
const ModalTermosDeUso = ({ onClose }: TermosDeUsoProps) => {
    ...
    return (
        <div className="fixed inset-0  bg-opacity-40 flex items-center justify-center p-4 z-50">
            <div ref={contentRef} className="bg-white p-6 rounded-xl shadow-2xl max-w-4xl w-full max-h-[90vh] overflow-y-auto relative border-2 border-purple-100">

                {/* Header com gradiente laranja */}
                <div className="bg-gradient-to-r from-purple-500 to-purple-600 rounded-t-lg -m-6 mb-6 p-6">
                    <div className="flex items-center justify-between">
                        <div>
                            <h1 className="text-2xl font-bold text-white mb-2">Termos de Uso</h1>
                            <p className="text-purple-100 text-sm">Versão vigente: {new Date().toLocaleDateString('pt-BR')}</p>
                        </div>
                        <button
                            className="text-white hover:text-purple-200 text-2xl font-bold transition-all duration-200 hover:scale-110 w-10 h-10 flex items-center justify-center rounded-full hover:bg-purple-700"
                            onClick={onClose}
                ...
                <div className="text-gray-800 space-y-6">
                    ...
                    <section className="bg-purple-50 rounded-lg p-4 border-l-4 border-purple-500">
                        <h2 className="text-lg font-semibold text-purple-800 mb-2">Aceitação dos Termos</h2>
                    ...
                    <section className="space-y-4">
                        <h2 className="text-xl font-bold text-purple-700 border-b border-purple-200 pb-2">
                    ...
                    <section className="space-y-4">
                        ...
                        <div className="bg-purple-50 p-4 rounded-lg border border-purple-200">
                            <h3 className="font-semibold text-purple-700 mb-3">Alterações Contratuais</h3>
                            ...
                            <div className="grid md:grid-cols-3 gap-3 text-xs">
                                <div className="text-center">
                                    <div className="bg-purple-100 rounded-full w-8 h-8 flex items-center justify-center mx-auto mb-1">
                                        <span className="text-purple-600 font-bold">1</span>
                                    </div>
                                    <p className="text-purple-700">Comunicação prévia</p>
                                </div>
                                <div className="text-center">
                                    <div className="bg-purple-100 rounded-full w-8 h-8 flex items-center justify-center mx-auto mb-1">
                                        <span className="text-purple-600 font-bold">2</span>
                                    </div>
                                    <p className="text-purple-700">Aceitação tácita</p>
                                </div>
                                <div className="text-center">
                                    <div className="bg-purple-100 rounded-full w-8 h-8 flex items-center justify-center mx-auto mb-1">
                                        <span className="text-purple-600 font-bold">3</span>
                                    </div>
                                    <p className="text-purple-700">Vigência imediata</p>
                                </div>
                            </div>
                        </div>
                    ...
                    {/* Aviso Final */}
                    <section className="bg-gradient-to-r from-purple-500 to-purple-500 rounded-lg p-4 text-white">
                ...
                <div className="flex flex-col sm:flex-row justify-between items-center pt-6 mt-6 border-t border-purple-100 gap-4">
                    ...
                    <div className="flex gap-3">
                        ...
                        <button
                            onClick={onClose}
                            className="bg-purple-500 hover:bg-purple-600 text-white font-medium py-2 px-6 rounded-lg transition-all duration-200 transform hover:scale-105 shadow-md"
                        >
